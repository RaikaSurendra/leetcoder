...
/**
 * Test cases for Maximum Matrix Sum problem
 */
public class SolutionTest {
    ...
    public void testAllNegativeEven() {
        int[][] matrix = {{-1, -2}, {-3, -4}};
        long expected = 10L; // 4 negatives (even) → all can be made positive
        long actual = solution.maxMatrixSum(matrix);
    ...
    public void testOddNegativeCount() {
        int[][] matrix = {{-1, 2}, {3, 4}};
        long expected = 8L; // 1+2+3+4 - 2*1 = 10-2 = 8
        long actual = solution.maxMatrixSum(matrix);
    ...
    public void testWithZero() {
        int[][] matrix = {{0, -1}, {2, 3}};
        long expected = 6L; // If zero exists and odd negatives, zero can "absorb" the negative
        long actual = solution.maxMatrixSum(matrix);
    ...
    public void testSingleNegative() {
        ...
        long expected = 40L; // 5+10+15+20 - 2*5 = 50-10 = 40
        long actual = solution.maxMatrixSum(matrix);
    ...
    public void testLargeValues() {
        ...
        long expected = 400000L; // Even negatives → all positive
        long actual = solution.maxMatrixSum(matrix);
